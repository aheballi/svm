...
$TestCaseName="18AppxImport_FromSCCM_ValidateProperties"
$csvFileName="AppxImport_FromSCCM_Validate.csv"
...
$xmlpath = $TestCaseFolder + "\"+ "Blender.xml"
$dependency1 = $TestCaseFolder + "\"+ "Firefox.xml"
$dependency2 = $TestCaseFolder + "\"+ "GoogleEarth.xml"
$dependency3 = $TestCaseFolder + "\"+ "Evernote.xml"
$supersedes1 = $TestCaseFolder + "\"+ "Viber.xml"
$supersedes2 = $TestCaseFolder + "\"+ "Alljoyn.xml"
$supersedes3 = $TestCaseFolder + "\"+ "WindowsServerApp.xml"  
$updatexmlpath = $TestCaseFolder + "\"+ "Blender_Update.xml"
...
If(Select-String -Pattern "Failed" -InputObject $(Get-Content $logFile))
{
	...
	Write-host (Write-Header $TestCaseName) "AppxImport_FromSCCM_ValidateProperties Test Case Failed"
    WriteResultsToFile $logFile "AppxImport_FromSCCM_ValidateProperties Test Case Failed:" $retval -1
    $retval=-1
	exit 1
}
Else 
{
    ...
    Get-Process AdminStudioHost | Stop-Process
	Write-host (Write-Header $TestCaseName) "AppxImport_FromSCCM_ValidateProperties Test Case Passed"
    WriteResultsToFile $logFile "AppxImport_FromSCCM_ValidateProperties Test Case Passed:" $retval -1
    $retval=0
	exit 0
}
