...
$TestCaseName="19PS1Import_FromSCCM_ValidateProperties"
$csvFileName="PS1Import_FromSCCM_Validate.csv"
...
$dependency1 = $TestCaseFolder + "\"+ "GoogleEarth.xml"
$dependency2 = $TestCaseFolder + "\"+ "Opera.xml"
$dependency3 = $TestCaseFolder + "\"+ "WireShark.xml"
$dependency4 = $TestCaseFolder + "\"+ "Adaware.xml"
$dependency5 = $TestCaseFolder + "\"+ "Hyena.xml"
$supersedes1 = $TestCaseFolder + "\"+ "SilverLight.xml"
$supersedes2 = $TestCaseFolder + "\"+ "Wrar.xml"
$supersedes3 = $TestCaseFolder + "\"+ "Xampp.xml"
$supersedes4 = $TestCaseFolder + "\"+ "Blender.xml"  
...
$dependency4 = ASCreateApplicationFromSCCMXML $dependency4 $SCCM_ConnectionName $TargetGroup   
$dependency5 = ASCreateApplicationFromSCCMXML $dependency5 $SCCM_ConnectionName $TargetGroup 
...
$parseDependency4PackageSCCIDs=$Dependency4.Split("{;}")
$DependencyAppID4=$parseDependency4PackageSCCIDs[0]
$DependencyDeploymenttypeID4= $parseDependency4PackageSCCIDs[1]

$parseDependency5PackageSCCIDs=$Dependency5.Split("{;}")
$DependencyAppID5=$parseDependency5PackageSCCIDs[0]
$DependencyDeploymenttypeID5= $parseDependency5PackageSCCIDs[1]

$ExpectedSCCMids1 = @($SupersedesAppId1,$SupersedesDeploymenttypeId1,$SupersedesAppId2,$SupersedesDeploymenttypeId2,$DependencyAppID1,$DependencyDeploymenttypeID1,$DependencyAppID2,$DependencyDeploymenttypeID2,$DependencyAppID3,$DependencyDeploymenttypeID3,$SCCMScopeid)
$Placeholder1 = @("<SupersedesAppId1>","<SupersedesDeploymenttypeId1>","<SupersedesAppId2>","<SupersedesDeploymenttypeId2>","<DependencyAppID1>","<DependencyDeploymenttypeID1>","<DependencyAppID2>","<DependencyDeploymenttypeID2>","<DependencyAppID3>","<DependencyDeploymenttypeID3>","<Scope_Id>")
...
$Placeholder2= @("<SCCMAppId>","<SCCMDeploymentId>","<SupersedesAppId1>","<SupersedesDeploymenttypeId1>","<SupersedesAppId3>","<SupersedesDeploymenttypeId3>","<SupersedesAppId4>","<SupersedesDeploymenttypeId4>","<DependencyAppID1>","<DependencyDeploymenttypeID1>","<DependencyAppID2>","<DependencyDeploymenttypeID2>","<DependencyAppID4>","<DependencyDeploymenttypeID4>","<DependencyAppID5>","<DependencyDeploymenttypeID5>","<Scope_Id>")

$ExpectedSCCMids2=@($SCCMAppId,$SCCMDeploymentId,$SupersedesAppId1,$SupersedesDeploymenttypeId1,$SupersedesAppId3,$SupersedesDeploymenttypeId3,$SupersedesAppId4,$SupersedesDeploymenttypeId4,$DependencyAppID1,$DependencyDeploymenttypeID1,$DependencyAppID2,$DependencyDeploymenttypeID2,$DependencyAppID4,$DependencyDeploymenttypeID4,$DependencyAppID5,$DependencyDeploymenttypeID5,$SCCMScopeid)
...
If(Select-String -Pattern "Failed" -InputObject $(Get-Content $logFile))
{
	...
	Write-host (Write-Header $TestCaseName) "PS1Import_FromSCCM_ValidateProperties Test Case Failed"
    WriteResultsToFile $logFile "PS1Import_FromSCCM_ValidateProperties Test Case Failed:" $retval -1
    $retval=-1
	exit 1
}
Else 
{
    ...
    Get-Process AdminStudioHost | Stop-Process
	Write-host (Write-Header $TestCaseName) "PS1Import_FromSCCM_ValidateProperties Test Case Passed"
    WriteResultsToFile $logFile "PS1Import_FromSCCM_ValidateProperties Test Case Passed:" $retval -1
    $retval=0
	exit 0
}
