...
$TestCaseName="13EXEImport_FromSCCM_ValidateProperties"
$csvFileName="EXEImport_FromSCCM_ValidateProperties.csv"
...
$Placeholder2= @("<SCCMAppId>","<SCCMDeploymentId>","<SupersedesAppId2>","<SupersedesDeploymenttypeId2>","<SupersedesAppId3>","<SupersedesDeploymenttypeId3>","<DependencyAppID2>","<DependencyDeploymenttypeID2>","<DependencyAppID3>","<DependencyDeploymenttypeID3>","<Scope_Id>")

$ExpectedSCCMids2=@($SCCMAppId,$SCCMDeploymentId,$SupersedesAppId2,$SupersedesDeploymenttypeId2,$SupersedesAppId3,$SupersedesDeploymenttypeId3,$DependencyAppID2,$DependencyDeploymenttypeID2,$DependencyAppID3,$DependencyDeploymenttypeID3,$SCCMScopeid)
...
If(Select-String -Pattern "Failed" -InputObject $(Get-Content $logFile))
{
	...
	Write-host (Write-Header $TestCaseName) "EXEImport_FromSCCM_ValidateProperties Test Case Failed"
    WriteResultsToFile $logFile "EXEImport_FromSCCM_ValidateProperties Test Case Failed:" $retval -1
    $retval=-1
	exit 1
}
Else 
{
    ...
    Get-Process AdminStudioHost | Stop-Process
	Write-host (Write-Header $TestCaseName) "EXEImport_FromSCCM_ValidateProperties Test Case Passed"
    WriteResultsToFile $logFile "EXEImport_FromSCCM_ValidateProperties Test Case Passed:" $retval -1
    $retval=0
	exit 0
}
