...
. C:\TestSetDev\TestsDev\AS_Powershell_Library.ps1

#Variable Declaration
$TestName = "ConvertMSItoAll_UsingAS4.6"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="ConvertMSItoAll_UsingAS4.6"
$CatalogName="ConvertMSItoAll_UsingAS4.6"
$TestRunStatus=0
$SRFlag=0
...
#Copying TestData
$SourcePath = "\\10.80.150.184\Automation_TestData\AACConversions\ConvertMSItoAll_UsingAS4.6"
