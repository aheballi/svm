...
$TestName = "Convert_InnoSetupEXEtoAll_Esxi6.7_UsingSeq"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

#CopyInnoSetupDll
$InnosetupDLL = "innounp.exe"
$InnosetupDLLSourcePath = "\\10.80.150.184\Automation_TestData\Import\SuiteExes_BundledPkgs\SuiteEXEDLLS\InnoSetup\" + $InnosetupDLL
...
$TestCaseName="Convert_InnoSetupEXEtoAll_Esxi6.7_UsingSeq"
$CatalogName="Convert_InnoSetupEXEtoAll_Esxi6.7_UsingSeq"
$TestRunStatus=0
$SRFlag=0
...
#Copying TestData
$SourcePath = "\\10.20.150.10\AdminStudio\AS_Automation\TestCases\AACConversions\Convert_InnoSetupEXEtoAll_Esxi6.7_UsingSeq"
