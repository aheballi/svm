...
$TestName = "Convert_NullSoftEXEtoAll_Esxi6.7_UsingSeq"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="Convert_NullSoftEXEtoAll_Esxi6.7_UsingSeq"
$CatalogName="Convert_NullSoftEXEtoAll_Esxi6.7_UsingSeq"
$TestRunStatus=0
$SRFlag=0
...
#Copying TestData
$SourcePath = "\\10.20.150.10\AdminStudio\AS_Automation\TestCases\AACConversions\Convert_NullSoftEXEtoAll_Esxi6.7_UsingSeq"
