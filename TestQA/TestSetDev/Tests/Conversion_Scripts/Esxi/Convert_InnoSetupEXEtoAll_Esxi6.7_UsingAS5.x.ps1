...
$TestName = "Convert_InnoSetupEXEtoAll_Esxi6.7_UsingAS5.x"
...
$TestCaseName="Convert_InnoSetupEXEtoAll_Esxi6.7_UsingAS5.x"
$CatalogName="Convert_InnoSetupEXEtoAll_Esxi6.7_UsingAS5.x"
$TestRunStatus=0
$SRFlag=0
...
$SourcePath = "\\10.80.150.184\Automation_TestData\AACConversions\Convert_InnoSetupEXEtoAll_Esxi6.7_UsingAS5.x"
