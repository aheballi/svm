...
$TestName = "Convert_WiseScriptEXEtoAll_Esxi6.7_UsingAS5.x"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="Convert_WiseScriptEXEtoAll_Esxi6.7_UsingAS5.x"
$CatalogName="Convert_WiseScriptEXEtoAll_Esxi6.7_UsingAS5.x"
$TestRunStatus=0
$SRFlag=0
...
$SourcePath = "\\10.80.150.184\Automation_TestData\AACConversions\Convert_WiseScriptEXEtoAll_Esxi6.7_UsingAS5.x"
