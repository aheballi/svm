...
$TestName = "Convert_17ConvertMSIWrappedtoAll_UsingSeq"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="Convert_17ConvertMSIWrappedtoAll_UsingSeq"
$CatalogName="Convert_17ConvertMSIWrappedtoAll_UsingSeq"
$TestRunStatus=0
$SRFlag=0
