...
$TestName = "ConvertMSIWrappedtoAll_UsingAS4.6"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="ConvertMSIWrappedtoAll_UsingAS4.6"
$CatalogName="ConvertMSIWrappedtoAll_UsingAS4.6"
$TestRunStatus=0
$SRFlag=0
...
#Copying TestData
$SourcePath = "\\10.80.150.184\Automation_TestData\AACConversions\ConvertMSIWrappedtoAll_UsingAS4.6"
