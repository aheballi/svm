...
$TestName = "ConvertMSIWrappedtoAll_WithoutWrapAPI_UsingAS5.x"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="ConvertMSIWrappedtoAll_WithoutWrapAPI_UsingAS5.x"
$CatalogName="ConvertMSIWrappedtoAll_WithoutWrapAPI_UsingAS5.x"
$TestRunStatus=0
$SRFlag=0
$AppVLauncherFile="C:\AS_Automation\ConvertMSIWrappedtoAll_WithoutWrapAPI_UsingAS5.x\TestData\AppVLaunch.ps1"
