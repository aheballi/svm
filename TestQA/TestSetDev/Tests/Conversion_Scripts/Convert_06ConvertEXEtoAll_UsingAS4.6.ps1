...
$TestCaseName="ConvertEXEtoAll_UsingAS4.6"
$CatalogName="ConvertEXEtoAll_UsingAS4.6"
$TestRunStatus=0
$SRFlag=0
...
#Copying TestData
$SourcePath = "\\10.80.150.184\Automation_TestData\AACConversions\ConvertEXEtoAll_UsingAS4.6"
