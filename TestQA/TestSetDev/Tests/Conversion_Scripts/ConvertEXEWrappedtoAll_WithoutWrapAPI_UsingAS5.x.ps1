...
$TestName = "ConvertEXEWrappedtoAll_WithoutWrapAPI_UsingAS5.x"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="ConvertEXEWrappedtoAll_WithoutWrapAPI_UsingAS5.x"
$CatalogName="ConvertEXEWrappedtoAll_WithoutWrapAPI_UsingAS5.x"
$TestRunStatus=0
$SRFlag=0
$AppVLauncherFile="C:\AS_Automation\ConvertEXEWrappedtoAll_WithoutWrapAPI_UsingAS5.x\TestData\AppVLaunch.ps1"
...
#Copying TestData
$SourcePath = "\\10.80.150.184\Automation_TestData\AACConversions\ConvertEXEWrappedtoAll_WithoutWrapAPI_UsingAS5.x"
