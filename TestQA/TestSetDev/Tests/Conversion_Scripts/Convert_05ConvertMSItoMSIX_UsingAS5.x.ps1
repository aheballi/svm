...
$TestName = "ConvertMSItoMSIX_UsingAS5.x"
Write-Host (Write-Header $TestName) "TestCase Execution Started..."

$ParentFolder = "C:\AS_Automation"
$TestCaseName="ConvertMSItoMSIX_UsingAS5.x"
$CatalogName="ConvertMSItoMSIX_UsingAS5.x"
$TestRunStatus=0
$SRFlag=0
...
#Copying TestData
$SourcePath = "\\10.80.150.184\Automation_TestData\AACConversions\ConvertMSItoMSIX_UsingAS5.x"
