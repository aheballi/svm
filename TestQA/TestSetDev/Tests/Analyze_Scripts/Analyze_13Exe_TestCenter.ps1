...
$DefaultExe         =  @('*.EXE')
$srcfolderExe="\\10.80.150.184\Automation_TestData\Analyze\Exe_Tests\Packages"
$destfolderExe="C:\AS_Automation\Exe_Tests"
$folderExe          = "C:\AS_Automation\Exe_Tests\SuiteExePackages"
$sCurrentLoc	="C:\Program Files (x86)\AdminStudio\2018\Common"
If ( (Get-WmiObject Win32_OperatingSystem).OSArchitecture -eq "64-bit" )
    {
        $TestResultFile     = "C:\AS_Automation\Exe_Tests\Win64Bit\ExeTestResults.txt"
        $DLLFolder = "C:\Program Files (x86)\AdminStudio\2018\Common\Tools"
    }
else
    {
        $TestResultFile     = "C:\AS_Automation\Exe_Tests\Win32Bit\ExeTestResults.txt"
        $DLLFolder = "C:\Program Files\AdminStudio\2018\Common\Tools"
    }


$global:CatalogName = 'Exe_Tests'
$global:TestErrorCount = 0

#CopyInnoSetupDll
   $dllInnosetup = "innounp.exe"
   $strDLLSourcePath = "\\10.80.150.184\Automation_TestData\Analyze\Exe_Tests\SuiteEXEDLLS\InnoSetup\" + $dllInnosetup
...
$ToolsFolder        = Join-Path $sAsLoc "Tools"
...
{
    $Header = ('['+(Get-Date -Format 'hh:mm:ss')+']') + ' [028Exe_TestCenter]'
    return $Header
}
...
{
    $global:oPkgArray   = @()
    $global:CatalogName = 'Exe_Tests' + $Name
...
try
{
   ...
   CopyTestDataLocally $srcfolderExe $destfolderExe 0
