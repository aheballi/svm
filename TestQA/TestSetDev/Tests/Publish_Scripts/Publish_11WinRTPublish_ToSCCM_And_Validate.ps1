...
#start
$TestName='11WinRTPublish_ToSCCM_And_Validate'

$ParentFolder = "C:\AS_Automation"
$TestCaseName="11WinRTPublish_ToSCCM_And_Validate"
$PackageName = "Viber.appx"
$Dep1 = "Blender.appx"
$Dep2 ="GoogleEarth.appx"
$Sup1="Evernote.appx"
$Sup2="Firefox.appx"
$csvFileName="WinRTPublish_ToSCCM_And_Validate"+$SCCMServerVersion+".csv"
$AppId=0
...
$SCCM_ConnectionName= "SCCM_WinRT"
...
{
    Write-host (Write-Header $TestName) "WinRTPublish_ToSCCM_And_Validate Test Case Failed"
    $retval=-1
...
Else 
{
    Write-host (Write-Header $TestName) "WinRTPublish_ToSCCM_And_Validate Test Case Passed"
    $retval=0
	#Deleting catalog
