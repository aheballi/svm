...
#start
$TestName='07APKPublish_ToSCCM_And_Validate'

$ParentFolder = "C:\AS_Automation"
$TestCaseName="07APKPublish_ToSCCM_And_Validate"
$PackageName = "Adobe Reader.apk"
$Sup1="LinkedIn.apk"
$Sup2="Password Manager.apk"
$csvFileName="APKPublish_ToSCCM_And_Validate.csv"
$AppId=0
...
WriteResultsToFile $logFile "Unselecting all rules for the catalog $CatalogName is: " $retval 0
...
{
    Write-host (Write-Header $TestName) "APKPublish_ToSCCM_And_Validate Test Case Failed"
    $retval=-1
...
Else 
{
    Write-host (Write-Header $TestName) "APKPublish_ToSCCM_And_Validate Test Case Passed"
    $retval=0
	#Deleting catalog
