...
#start
$TestName='02WrappedMSIPublish_ToSCCM_And_Validate'
$ParentFolder = "C:\AS_Automation"
$TestCaseName="02WrappedMSIPublish_ToSCCM_And_Validate"
...
if($wrapid -ge -1)
{
        ...
        AddAppModelData $Type $DeviceRequirementXmlPath1 $wrapid
        ...
        AddAppModelData $Type $DeviceRequirementXmlPath2 $wrapid
        ...
        AddAppModelData $Type $DeviceRequirementXmlPath3 $wrapid
        ...
        AddAppModelData $Type $FreeDiskDeviceRequirementXmlPath $wrapid
        ...
        AddAppModelData $Type $FileDetectionMethodXmlPath $wrapid
        ...
        AddAppModelData $Type $FolderDetectionMethodXmlPath $wrapid
        ...
        AddAppModelData $Type $RegistryDetectionMethodXmlPath $wrapid
        ...
        AddAppModelData $Type $InstallerDetectionMethodXmlPath $wrapid
        ...
        $Type="Supercedence"
        $Uninstall="true"
        UpdateAppModelData $Type $SupersedenceXmlPath $wrapid $Uninstall
        ...
        UpdateAppModelData $Type $UpdatedDeviceRequirementXmlPath1 $wrapid
        ...
        UpdateAppModelData $Type $UpdatedDeviceRequirementXmlPath2 $wrapid
        ...
        UpdateAppModelData $Type $UpdatedDeviceRequirementXmlPath3 $wrapid
        ...
        UpdateAppModelData $Type $UpdatedFreeDiskDeviceRequirementXmlPath $wrapid

        #Removing DeviceRequirement
        $Type="DeviceRequirement"
        $AppIndex=11
        RemoveAppModelData $Type $wrapid $AppIndex
        ...
        UpdateAppModelData $Type $FileDetectionMethodXmlPathUpdate $wrapid
        ...
        UpdateAppModelData $Type $FolderDetectionMethodXmlPathUpdate $wrapid
        ...
        UpdateAppModelData $Type $RegistryDetectionMethodXmlPathUpdate $wrapid
        ...
        UpdateAppModelData $Type $InstallerDetectionMethodXmlPathUpdate $wrapid
        ...
        UpdateAppModelData $Type $UpdatedUserRequirementXmlPath $wrapid
        ...
        $Type= "WrapDetectionMethod"
        $order = 3
        RemoveAppModelData $Type $wrapid $order
        ...
        If(Select-String -Pattern "Failed" -InputObject $(Get-Content $logFile))
        {
			...
			Write-host (Write-Header $TestName) "WrappedMSIPublish_ToSCCM_And_Validate Test Case Failed"
            $retval=-1
			exit 1
        }
        Else 
        {
            Write-host (Write-Header $TestName) "WrappedMSIPublish_ToSCCM_And_Validate Test Case Passed"
            $retval=0
			#Deleting catalog
