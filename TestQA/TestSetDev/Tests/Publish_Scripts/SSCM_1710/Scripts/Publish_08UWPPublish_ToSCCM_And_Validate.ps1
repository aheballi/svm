...
$Sup1="Evernote.appx"
$Sup2="Firefox.appx"
$csvFileName="UWPPublish_ToSCCM_And_Validate.csv"
$AppId=0
...
#Adding Dependency
$Type="Dependency"
$DependencyXmlPath="C:\AS_Automation\08UWPPublish_ToSCCM_And_Validate\XmlDocuments\Dependency.xml"
AddAppModelData $Type $DependencyXmlPath $PkgID $depPkgID1

#Adding UserRequirement
$Type="UserRequirement"
$UserRequirementXmlPath="C:\AS_Automation\08UWPPublish_ToSCCM_And_Validate\XmlDocuments\UserRequirement.xml"
AddAppModelData $Type $UserRequirementXmlPath $PkgID

#Adding DeviceRequirement
$Type="DeviceRequirement"
$DeviceRequirementXmlPath="C:\AS_Automation\08UWPPublish_ToSCCM_And_Validate\XmlDocuments\DeviceRequirement.xml"
AddAppModelData $Type $DeviceRequirementXmlPath $PkgID

#Adding Supercedence
$Type="Supercedence"
$SupersedenceXmlPath="C:\AS_Automation\08UWPPublish_ToSCCM_And_Validate\XmlDocuments\Supersedence.xml"
AddAppModelData $Type $SupersedenceXmlPath $PkgID $SuperPkgID1

#Adding ReturnCodes
$Type="ReturnCodes"
$ReturnCodesXmlPath="C:\AS_Automation\08UWPPublish_ToSCCM_And_Validate\XmlDocuments\ReturnCodes.xml"
