...
#start
$TestName='09EXEPublish_ToSCCM_And_Validate'
#$SCCMServerVersion = '1710'
$ParentFolder = "C:\AS_Automation"
$TestCaseName="09EXEPublish_ToSCCM_And_Validate"
$PackageName = "Ad-AwareAE.exe"
$Dep1 ="prune.exe"
$Dep2 ="JetAudio.msi"
$Sup1="Stamper.exe"
$Sup2="Real player.msi"
$csvFileName="EXEPublish_ToSCCM_And_Validate"+$SCCMServerVersion+".csv"
$AppId=0
...
<#$SupSqlPath= $SQLScriptsFolder +'\DetectionMethod\Supersedence'
AddDetectionMethod $SupSqlPath $SuperPkgID1 $CatalogName#>

#$Type="DetectionMethod"
#$DetectionMethodXmlPath="$ParentFolder\$TestCaseName\XmlDocuments\DetectionMethodMultiple.xml"
...
<#$DepSqlPath=  $SQLScriptsFolder +'\DetectionMethod\Dependency'
AddDetectionMethod $DepSqlPath $depPkgID1 $CatalogName#>
...
Add-Content -Path $logFile -Value "publish id: $SCCMID"
...
AddSupersedence $Sup2SqlPath $PkgId $SuperPkgID2 $CatalogName

$Dep2SqlPath= $SQLScriptsFolder +'\Dependency\Update'
UpdateDependencies $Dep2SqlPath $PkgId $depPkgID1 $depPkgID2 $CatalogName
...
Add-Content -Path $logFile -Value "republish application ID :$ID"
...
{
    Write-host (Write-Header $TestName) "EXEPublish_ToSCCM_And_Validate Test Case Failed"
    $retval=-1
...
Else 
{
    Write-host (Write-Header $TestName) "EXEPublish_ToSCCM_And_Validate Test Case Passed"
    $retval=0
	#Deleting catalog
