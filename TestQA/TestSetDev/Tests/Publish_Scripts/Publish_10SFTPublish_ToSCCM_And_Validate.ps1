...
$csvFileName="SFTPublish_ToSCCM_And_Validate"+$SCCMServerVersion+".csv"
$AppId=0
...
$ReturnCodesXmlPath = "C:\AS_Automation\10SFTPublish_ToSCCM_And_Validate_1906\XmlDocuments\ReturnCodes.xml"
$Type="ReturnCodes"
$Name="test"
