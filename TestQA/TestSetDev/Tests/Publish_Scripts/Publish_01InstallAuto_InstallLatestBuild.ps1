...
$BuildShare          = "\\aswfmfs"
$BuildLocation       = $BuildShare + "\Builds\AdminStudio\19.0 (Jehangir R1_New_Git)"
...
#$ActivationCode = "3082-AEFA-30D8-9FDA"
...
#$global:GreatestBuildNo = "2532_RTM_Refresh1"  
...
{ 
    ...
    Set-itemProperty -path "Registry::HKLM\Software\InstallShield\AdminStudio\19.0" -name "LSProductID" -Value "Eval"
	Set-itemProperty -path "Registry::HKLM\Software\InstallShield\AdminStudio\19.0" -name "LicenseServer" -Value "@10.20.151.68"
