...
$TestCaseName="ValidatemsiwrapCustomtemoutputLoc"
$strSourcePath = "\\10.20.150.10\AdminStudio\AS_Automation\TestCases\"+$TestCaseName
$CatalogName ="ValidatemsiwrapCustomtemoutputLoc"
...
Package      : JetAudio
File Name    : $CustomOutputFolder\JetAudio_$PkgID\Files\$msiPackage
